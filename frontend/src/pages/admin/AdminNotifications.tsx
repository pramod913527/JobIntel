      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-3xl font-bold text-foreground">12,450</div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-3xl font-bold text-foreground">98.2%</div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-3xl font-bold text-foreground">96.8%</div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-3xl font-bold text-foreground">3</div>
              ...
              >
                <div className="flex-1 space-y-2">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={cn('capitalize', statusColors[notification.status])}
                    >
                      <span className="mr-1">{statusIcons[notification.status]}</span>
                      {notification.status}
                    </Badge>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-sm">
                    <div className="flex items-center gap-1">
                      {audienceIcons[notification.targetAudience]}
