  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Hero buttons
        hero: "gradient-hero text-white font-semibold shadow-glow hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]",
        heroOutline: "border-2 border-white/30 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 hover:border-white/50",
        // Accent/CTA buttons  
        accent: "bg-accent text-accent-foreground hover:opacity-90 shadow-soft hover:shadow-elevated",
        accentOutline: "border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground",
        // Premium tier buttons
        premium: "gradient-premium text-white font-semibold shadow-soft hover:shadow-elevated hover:scale-[1.02]",
        ultra: "gradient-ultra text-black font-semibold shadow-soft hover:shadow-elevated hover:scale-[1.02]",
        // Subtle buttons
